              ...
              <motion.div key="communications" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }} className="space-y-6">
                ...
                <div className="space-y-4">
                  {selectedClient.communications.map((comm) => (
                    <Card key={comm.id} className="bg-white/[0.03] border-white/[0.07] hover:bg-white/[0.04] transition-colors">
                ...
                <Card className="bg-white/[0.03] border-white/[0.07] overflow-hidden">
                  <div className="overflow-x-auto">
                    <table className="w-full text-sm text-left">
                      <thead className="text-xs text-slate-500 uppercase tracking-widest font-mono bg-white/[0.04] border-b border-white/[0.07]">
                        <tr>
                      ...
                      <tbody>
                        {selectedClient.invoices.map((inv) => (
                          <tr key={inv.id} className="border-b border-white/[0.07] hover:bg-white/[0.04] transition-colors">
              ...
              <motion.div key="documents" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }}>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {selectedClient.documents.map((doc) => (
                    <Card key={doc.id} className="bg-white/[0.03] border-white/[0.07] hover:bg-white/[0.03] transition-colors group cursor-pointer">
                  ...
                  <Card className="bg-white/[0.03] border-white/[0.07] border-dashed hover:bg-white/[0.04] transition-colors cursor-pointer flex flex-col items-center justify-center min-h-[100px] text-slate-500 hover:text-white group">
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Card className="bg-gradient-to-br from-blue-900/30 to-blue-900/10 border-blue-500/20 relative overflow-hidden">
        ...
        <Card className="bg-gradient-to-br from-orange-900/30 to-orange-900/10 border-orange-500/20 relative overflow-hidden">
      ...
      <Card className="bg-white/[0.03] border-white/[0.07] overflow-hidden">
        ...
        <CardContent className="p-0">
          <div className="overflow-x-auto">
            <table className="w-full text-sm text-left">
              <thead className="text-xs text-slate-500 uppercase tracking-widest font-mono bg-white/[0.04] border-y border-white/[0.07]">
                <tr>
              ...
              <tbody>
                {filteredClients.map((client) => (
                  <tr 
                    ...
                    className="border-b border-white/[0.07] hover:bg-white/[0.03] transition-colors group cursor-pointer"
                  >
